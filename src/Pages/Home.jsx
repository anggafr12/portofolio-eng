...
const WORDS = ["Full Stack Developer", "Tech Enthusiast", "Internet of Things"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind", "Python"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/anggafr12" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/anggafr/" },
  { icon: Instagram, link: "https://www.instagram.com/anggafr_12" }
];
